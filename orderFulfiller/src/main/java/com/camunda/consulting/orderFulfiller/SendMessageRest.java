...
public class SendMessageRest implements JavaDelegate {
	...
	private static final String HOST_CUSTOMER = "localhost:8082";
	private static final String REST_ENDPOINT = "http://" + HOST_CUSTOMER + "/rest/message";
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		ResponseEntity<Object> result = new RestTemplate().postForEntity(REST_ENDPOINT, entity,
				null);
